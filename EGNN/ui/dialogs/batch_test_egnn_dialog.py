...
class BatchTestDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Configuración de Evaluación Múltiple - EGNN")
        self.resize(700, 460)

        self.settings = QSettings("Investigacion", "EGNN_BatchTesting")
        ...
        self.models_root_input.setPlaceholderText("Carpeta madre con varios modelos/runs")
        ...
        self.results_root_input.setPlaceholderText("Carpeta raíz de resultados")
