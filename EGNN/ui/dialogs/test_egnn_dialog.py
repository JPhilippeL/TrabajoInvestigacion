...
class TestDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Configuración de Evaluación - EGNN")
        self.resize(700, 460)

        self.settings = QSettings("Investigacion", "EGNN_Testing")
        ...
        self.models_dir_input.setPlaceholderText("Directorio de modelos del experimento")
        ...
        self.results_btn = QPushButton("Seleccionar...")
