...
class TrainDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Configuración de Entrenamiento - EGNN")
        self.resize(700, 520)

        self.settings = QSettings("Investigacion", "EGNN_Training")
        ...
        self.output_base_input.setPlaceholderText("Carpeta base de salida de modelos")
