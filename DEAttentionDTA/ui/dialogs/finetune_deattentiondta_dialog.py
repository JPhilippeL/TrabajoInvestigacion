"""Original-pretrained versus fine-tuned DEAttentionDTA comparison dialog."""
...
class FinetuneDEAttentionDTADialog(QDialog):
    def __init__(self, parent=None):
        ...
        form = QFormLayout(); form.addRow(QLabel("<b>1. Dataset, checkpoint and outputs</b>")); form.addRow("Prepared dataset:", with_button(self.prepared_dir_input, self.prepared_dir_btn)); form.addRow("Original checkpoint:", with_button(self.checkpoint_input, self.checkpoint_btn)); form.addRow("Results directory:", with_button(self.results_dir_input, self.results_dir_btn)); form.addRow("Models directory:", with_button(self.models_dir_input, self.models_dir_btn)); form.addRow("Official splits:", self.splits_input); form.addRow("Checkpoint fold:", self.pretrained_fold_input)
