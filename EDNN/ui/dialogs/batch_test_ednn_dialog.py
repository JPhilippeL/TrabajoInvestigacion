...
class BatchTestDialog(QDialog):
    """
    @brief Dialog used to configure EDNN evaluation over several model runs.
    """

    def __init__(self, parent=None) -> None:
        """
        @brief Initialize the EDNN batch evaluation dialog.
        ...
        self.batch_spin.setValue(self._int_setting("batch_test/batch_size", DEFAULT_BATCH_SIZE))

        self.hidden_dim_spin = QSpinBox()
        self.hidden_dim_spin.setRange(1, 4096)
        self.hidden_dim_spin.setValue(self._int_setting("batch_test/hidden_dim", DEFAULT_HIDDEN_DIM))
    ...
    def get_inputs(self) -> dict[str, object]:
        """
        @brief Return dialog values as EDNN batch evaluation parameters.
