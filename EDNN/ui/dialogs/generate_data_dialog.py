...
class DBGenerationDialog(QDialog):
    def __init__(self, parent=None):
        ...
        form_layout.addRow("Ligand_SDF dir:", self._with_button(self.ligand_sdf_dir_input, self.ligand_sdf_btn))
        form_layout.addRow("Protein_PDB dir:", self._with_button(self.protein_pdb_dir_input, self.protein_pdb_btn))
