...
@brief Constants used by the EDNN module.
"""
...
DEFAULT_GRAPHS_DIR = os.path.join(MODULE_ROOT, "Graphs_EDNN")
DEFAULT_MODELS_DIR = os.path.join(MODULE_ROOT, "Models_EDNN")
DEFAULT_RESULTS_DIR = os.path.join(MODULE_ROOT, "Results_EDNN")
