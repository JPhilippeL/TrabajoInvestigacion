...
class HyperparameterSearchDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.train_split_input.setText(
            str(self.settings.value("hpcheapnet/train_split_file", ""))
        )
        ...
        self.val_split_input.setText(
            str(self.settings.value("hpcheapnet/val_split_file", ""))
        )
        ...
        self.test_split_input.setText(
            str(self.settings.value("hpcheapnet/test_split_file", ""))
        )
        ...
        self.save_directory_input.setText(
            str(self.settings.value("hpcheapnet/save_directory", ""))
        )
        ...
        self.cpu_per_trials_input.setValue(
            int(self.settings.value("hpcheapnet/cpu_per_trials", 4))
        )
        ...
        self.gpu_per_trials_input.setValue(
            int(self.settings.value("hpcheapnet/gpu_per_trials", 0))
        )
        ...
        self.number_of_trials.setValue(
            int(self.settings.value("hpcheapnet/number_of_trials", 20))
        )
        ...
        self.hidden_dim_min.setValue(
            int(self.settings.value("hpcheapnet/hidden_dim_min", 32))
        )
        ...
        self.hidden_dim_max.setValue(
            int(self.settings.value("hpcheapnet/hidden_dim_max", 256))
        )
        ...
        self.batch_size_min.setValue(
            int(self.settings.value("hpcheapnet/batch_size_min", 4))
        )
        ...
        self.batch_size_max.setValue(
            int(self.settings.value("hpcheapnet/batch_size_max", 8))
        )
        ...
        self.lr_min.setValue(
            float(self.settings.value("hpcheapnet/lr_min", 1e-4))
        )
        ...
        self.lr_max.setValue(
            float(self.settings.value("hpcheapnet/lr_max", 1e-3))
        )
        ...
        self.drop_out_min.setValue(
            float(self.settings.value("hpcheapnet/drop_out_min", 0.0))
        )
        ...
        self.drop_out_max.setValue(
            float(self.settings.value("hpcheapnet/drop_out_max", 0.1))
        )

        self.epochs = QSpinBox()
        self.epochs.setRange(1, 10000)
        self.epochs.setValue(
            int(self.settings.value("hpcheapnet/epochs", 50))
        )
