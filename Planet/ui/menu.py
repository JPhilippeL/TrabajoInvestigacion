...
from Planet.ui.dialogs.data_generation_dialog import DBGenerationDialog
from Planet.worker import DBGenerationThread

logger = logging.getLogger(__name__)


class MenuPlanet(QMenu):
    def __init__(self, parent_window):
        super().__init__("Planet", parent_window)
    ...
    def generate_db(self):
        ...
        if dialog.exec():
            ...
            if not params["pic50_path"] or not params["sdf_dir"] or not params["pdb_dir"]:
