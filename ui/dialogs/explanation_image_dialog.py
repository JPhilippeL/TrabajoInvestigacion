...
class FullExplainerConfigDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Configuración Completa (Alfa - Delta)")
        self.resize(550, 400) 
        ...
        self.model_path_input.setPlaceholderText("Modelo base entrenado (.pt)")
        ...
        self.sdf_path_input.setPlaceholderText("Archivo de estructura (.sdf)")
        ...
        self.alpha_browse_btn = QPushButton("Seleccionar...")
        ...
        self.beta_browse_btn = QPushButton("Seleccionar...")
        ...
        self.gamma_browse_btn = QPushButton("Seleccionar...")
        ...
        self.delta_browse_btn = QPushButton("Seleccionar...")
    ...
    # ---------- Accept ----------
    def accept(self):
        # Guardar settings para la próxima vez
