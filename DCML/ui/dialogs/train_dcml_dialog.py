...
class TrainDCMLDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.use_folds_check = QCheckBox("Use dataset folds")
        self.use_folds_check.setChecked(str(self.settings.value("training/use_dataset_folds", "true")).lower() in {"true", "1", "yes"})
    ...
    def accept(self):
        ...
        self.settings.setValue("training/use_dataset_folds", self.use_folds_check.isChecked())
