...
class TestDCMLDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.cast_float32_check = QCheckBox("Cast features to float32"); self.cast_float32_check.setChecked(str(self.settings.value("evaluation/cast_float32", "true")).lower() in {"true", "1", "yes"})
