"""
@file menu_DeepDTA.py
@brief Menu integration for the DeepDTA module.
"""
...
from DeepDTA.ui.dialogs.evaluate_deepdta_dialog import EvaluateDeepDTADialog
from DeepDTA.ui.dialogs.generate_data_deepdta_dialog import GenerateDataDeepDTADialog
from DeepDTA.ui.dialogs.hyperparameter_search_deepdta_dialog import HyperparameterSearchDeepDTADialog
from DeepDTA.ui.dialogs.train_deepdta_dialog import TrainDeepDTADialog
from DeepDTA.workers import EvaluateThread, GenerateDataThread, TrainAllModelsThread, TrainThread


class MenuDeepDTA(QMenu):
    def __init__(self, parent_window):
        super().__init__("DeepDTA", parent_window)
    ...
    def open_generate_data_dialog(self):
        self.generate_thread = self._run_dialog(GenerateDataDeepDTADialog, GenerateDataThread, self.generate_action, self.on_generate_success, "DeepDTA Generate Data")

    def open_train_dialog(self):
        self.train_thread = self._run_dialog(TrainDeepDTADialog, TrainThread, self.train_action, self.on_train_success, "DeepDTA Train Model")

    def open_evaluate_dialog(self):
        self.evaluate_thread = self._run_dialog(EvaluateDeepDTADialog, EvaluateThread, self.evaluate_action, self.on_evaluate_success, "DeepDTA Evaluate/Predict Model")

    def open_hyperparameter_search_dialog(self):
        self.hyperparameter_search_thread = self._run_dialog(HyperparameterSearchDeepDTADialog, TrainAllModelsThread, self.hyperparameter_search_action, self.on_hyperparameter_search_success, "DeepDTA Hyperparameter Search")
    ...
    def on_generate_success(self, results: dict):
        ...
        QMessageBox.information(self.parent_window, "DeepDTA Data Generated", text)
    ...
    def on_train_success(self, results: dict):
        ...
        QMessageBox.information(self.parent_window, "DeepDTA Training Finished", text)
    ...
    def on_evaluate_success(self, results: dict):
        ...
        QMessageBox.information(self.parent_window, "DeepDTA Evaluation Finished", text)
    ...
    def on_hyperparameter_search_success(self, results: dict):
        ...
        QMessageBox.information(self.parent_window, "DeepDTA Hyperparameter Search Finished", text)
