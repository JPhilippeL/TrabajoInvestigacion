...
class TrainDeepDTADialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("DeepDTA Train Model")
        self.resize(720, 520)
        self.settings = QSettings("ResearchApp", "DeepDTA_Train")
        ...
        self.output_input = QLineEdit(self.settings.value("output_base", os.path.join(MODULE_ROOT, "results", "deepdta_runs")))
