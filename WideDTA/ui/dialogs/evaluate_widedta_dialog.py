...
from PySide6.QtWidgets import QComboBox, QDialog, QDialogButtonBox, QFileDialog, QFormLayout, QHBoxLayout, QLineEdit, QPushButton, QSpinBox, QVBoxLayout, QWidget

from WideDTA.utils.constants import DEFAULT_DATASET, DEFAULT_DEVICE, MODULE_ROOT


class EvaluateWideDTADialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("WideDTA Evaluate/Predict Model")
        self.resize(720, 380)
        self.settings = QSettings("ResearchApp", "WideDTA_Evaluate")
        ...
        self.output_input = QLineEdit(self.settings.value("output_dir", os.path.join(MODULE_ROOT, "results", "widedta_evaluation", "runs")))
    ...
    def get_inputs(self) -> dict:
        ...
        return {
            ...
            "device": self.device_combo.currentText(), "fold_index": self.fold_spin.value(), "use_dataset_folds": True,
