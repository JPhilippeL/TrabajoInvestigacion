...
class PredictDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.pic50_file_input.setText(self.settings.value("predict/pic50_txt", ""))
        ...
        self.parameter_file_input.setPlaceholderText("File with hyparameters used for training")
        self.parameter_file_input.setText(self.settings.value("predict/parameter_file", ""))
        ...
        form_layout.addRow("Parameters file", self._with_button(self.parameter_file_input, self.parameter_file_btn))
        layout = QVBoxLayout()
    ...
    def accept(self):
        ...
        self.settings.setValue("predict/parameter_file", self.parameter_file_input.text().strip())
        super().accept()
