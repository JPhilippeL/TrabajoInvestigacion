...
class HyperparameterSearchDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.train_split_input.setText(str(self.settings.value("hpcheapnet/train_split_file", "")))
        ...
        self.val_split_input.setText(str(self.settings.value("hpcheapnet/val_split_file", "")))
        ...
        self.test_split_input.setText(str(self.settings.value("hpcheapnet/test_split_file", "")))
        ...
        self.save_directory_input.setText(str(self.settings.value("hpcheapnet/save_directory", "")))
        ...
        self.graph_directory_input.setText(
            str(self.settings.value("hpcheapnet/graph_directory", ""))
        )
        ...
        self.cpu_per_trials_input.setValue(int(self.settings.value("hpcheapnet/cpu_per_trials", 4)))
        ...
        self.gpu_per_trials_input.setValue(int(self.settings.value("hpcheapnet/gpu_per_trials", 0)))
        ...
        self.number_of_trials.setValue(int(self.settings.value("hpcheapnet/number_of_trials", 20)))
        ...
        self.lr_max.setValue(float(self.settings.value("hpcheapnet/lr_max", 1e-3)))
        ...
        self.weight_decay_min.setValue(
            float(self.settings.value("hpcheapnet/weight_decay_min", 1e-6))
        )
        ...
        self.weight_decay_max.setValue(
            float(self.settings.value("hpcheapnet/weight_decay_max", 1e-3))
        )
        ...
        self.drop_out_min.setValue(float(self.settings.value("hpcheapnet/drop_out_min", 0.0)))
        ...
        self.drop_out_max.setValue(float(self.settings.value("hpcheapnet/drop_out_max", 0.1)))

        self.epochs = QSpinBox()
        self.epochs.setRange(1, 10000)
        self.epochs.setValue(int(self.settings.value("hpcheapnet/epochs", 50)))
    ...
    def save_settings(self):
        self.settings.setValue(
            "hpcheapnet/train_split_file",
            self.train_split_input.text().strip(),
        )
        self.settings.setValue(
            "hpcheapnet/val_split_file",
            self.val_split_input.text().strip(),
        )
        self.settings.setValue(
            "hpcheapnet/test_split_file",
            self.test_split_input.text().strip(),
        )
        self.settings.setValue(
            "hpcheapnet/save_directory",
            self.save_directory_input.text().strip(),
        )
        self.settings.setValue(
            "hpcheapnet/graph_directory",
            self.graph_directory_input.text().strip(),
        )

        self.settings.setValue(
            "hpcheapnet/cpu_per_trials",
            self.cpu_per_trials_input.value(),
        )
        self.settings.setValue(
            "hpcheapnet/gpu_per_trials",
            self.gpu_per_trials_input.value(),
        )
        self.settings.setValue(
            "hpcheapnet/number_of_trials",
            self.number_of_trials.value(),
        )

        self.settings.setValue("hpcheapnet/hidden_dim_min", self.hidden_dim_min.value())
        self.settings.setValue("hpcheapnet/hidden_dim_max", self.hidden_dim_max.value())

        self.settings.setValue("hpcheapnet/batch_size_min", self.batch_size_min.value())
        self.settings.setValue("hpcheapnet/batch_size_max", self.batch_size_max.value())

        self.settings.setValue("hpcheapnet/lr_min", self.lr_min.value())
        self.settings.setValue("hpcheapnet/lr_max", self.lr_max.value())

        self.settings.setValue(
            "hpcheapnet/weight_decay_min",
            self.weight_decay_min.value(),
        )
        self.settings.setValue(
            "hpcheapnet/weight_decay_max",
            self.weight_decay_max.value(),
        )

        self.settings.setValue("hpcheapnet/drop_out_min", self.drop_out_min.value())
        self.settings.setValue("hpcheapnet/drop_out_max", self.drop_out_max.value())

        self.settings.setValue("hpcheapnet/epochs", self.epochs.value())
