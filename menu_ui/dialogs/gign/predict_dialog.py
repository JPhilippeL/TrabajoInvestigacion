...
class PredictDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.test_split_input.setText(self.settings.value("train_gign/last_test_file", ""))
    ...
    def accept(self):
        ...
        self.settings.setValue("train_gign/last_test_file", self.test_split_input.text().strip())
        ...
        self.settings.setValue("dbGen/pic50_txt", self.pic50_file_input.text().strip())

        super().accept()

    def get_inputs(self) -> GIGNPredictionConfig:
        return GIGNPredictionConfig(
