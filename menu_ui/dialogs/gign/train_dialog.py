...
class TrainDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.train_file_input.setText(self.settings.value("train_gign/last_train_file", ""))
        ...
        self.test_file_input.setText(self.settings.value("train_gign/last_test_file", ""))
        ...
        self.val_file_input.setText(self.settings.value("train_gign/last_val_file", ""))
        ...
        self.graph_dir_input.setText(self.settings.value("train_gign/last_graph_dir", ""))
        ...
        self.save_dir_input.setText(self.settings.value("train_gign/last_save_dir", ""))
        ...
        self.hidden_dim_input.setValue(int(self.settings.value("train_gign/hidden_dim", 128)))

        self.batch_size_input = QSpinBox()
        self.batch_size_input.setRange(1, 100000)
        self.batch_size_input.setValue(int(self.settings.value("train_gign/batch_size", 32)))
        ...
        self.epochs_input.setValue(int(self.settings.value("train_gign/epochs", 50)))

        self.patience_input = QSpinBox()
        self.patience_input.setRange(1, 100)
        self.patience_input.setValue(int(self.settings.value("train_gign/patience", 15)))
        ...
        self.drop_out_input.setValue(float(self.settings.value("train_gign/drop_out", 0.1)))
    ...
    def accept(self):
        ...
        self.settings.setValue("train_gign/last_train_file", self.train_file_input.text().strip())
        self.settings.setValue("train_gign/last_test_file", self.test_file_input.text().strip())
        self.settings.setValue("train_gign/last_val_file", self.val_file_input.text().strip())
        self.settings.setValue("train_gign/last_graph_dir", self.graph_dir_input.text().strip())
        self.settings.setValue("train_gign/last_save_dir", self.save_dir_input.text().strip())
    ...
    def get_inputs(self) -> GIGNTrainerConfig:
        return GIGNTrainerConfig(
