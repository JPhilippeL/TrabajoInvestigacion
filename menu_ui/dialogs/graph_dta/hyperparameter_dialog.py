...
class HyperparameterSearchDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.train_split_input.setText(str(self.settings.value("hpgraphdta/train_split_file", "")))
        ...
        self.val_split_input.setText(str(self.settings.value("hpgraphdta/val_split_file", "")))
        ...
        self.test_split_input.setText(str(self.settings.value("hpgraphdta/test_split_file", "")))
        ...
        self.save_directory_input.setText(str(self.settings.value("hpgraphdta/save_directory", "")))
        ...
        self.cpu_per_trials_input.setValue(int(self.settings.value("hpgraphdta/cpu_per_trials", 5)))
        self.cpu_per_trials_input.setToolTip("Number of CPUs used for one trial.")
        ...
        self.number_of_trials.setValue(int(self.settings.value("hpgraphdta/number_of_trials", 40)))
        self.number_of_trials.setToolTip("Number of random hyperparameter combinations to test.")

        self.n_filters_min = QSpinBox()
        self.n_filters_min.setRange(8, 1024)
        self.n_filters_min.setSingleStep(8)
        self.n_filters_min.setValue(int(self.settings.value("hpgraphdta/n_filters_min", 16)))

        self.n_filters_max = QSpinBox()
        self.n_filters_max.setRange(8, 1024)
        self.n_filters_max.setSingleStep(8)
        self.n_filters_max.setValue(int(self.settings.value("hpgraphdta/n_filters_max", 128)))

        self.batch_size_min = QSpinBox()
        self.batch_size_min.setRange(1, 512)
        self.batch_size_min.setValue(int(self.settings.value("hpgraphdta/batch_size_min", 4)))

        self.batch_size_max = QSpinBox()
        self.batch_size_max.setRange(1, 512)
        self.batch_size_max.setValue(int(self.settings.value("hpgraphdta/batch_size_max", 64)))

        self.lr_min = QDoubleSpinBox()
        self.lr_min.setDecimals(8)
        self.lr_min.setRange(1e-8, 1.0)
        self.lr_min.setSingleStep(1e-4)
        self.lr_min.setValue(float(self.settings.value("hpgraphdta/lr_min", 1e-4)))
        ...
        self.lr_max.setValue(float(self.settings.value("hpgraphdta/lr_max", 1e-2)))
        ...
        self.dropout_min.setValue(float(self.settings.value("hpgraphdta/dropout_min", 0.0)))
        ...
        self.dropout_max.setValue(float(self.settings.value("hpgraphdta/dropout_max", 0.1)))

        self.epochs = QSpinBox()
        self.epochs.setRange(1, 10000)
        self.epochs.setValue(int(self.settings.value("hpgraphdta/epochs", 50)))
        ...
        self.patience.setToolTip("Patience is fixed to 15 in train_dta.")
